            ...
            try {
                ...
                $.each(json.valor.campos, function (i, campo) {
                    ...
                    if (camposRelacionados) {
                        console.log("Campo", camposRelacionados.elementoJson);
                    ...
                    if (idTipoCampo == 1) {
                        ...
                        if (parseInt(tipoOrigen) == 1) {
                            ...
                            htmlCampo += `
                                <div class="${htmlTamanio}">
                                <label for="texto">${etiqueta}</label>
                                  <select class="custom-select" id="${elementoJson}" name="${elementoJson}" ${htmlAdd}>
                            ...
                            htmlCampo += `
                                ...
                                <label for="texto">${campo.etiqueta}</label>
                                  <select class="custom-select" id="${campo.elementoJson}" name="${campo.elementoJson}" ${htmlAdd}>
                                        <option value="">${campo.elementoJsonPadre}</option>
                                    </select></div>`;
                        }
                                ...
                                <div class="${htmlTamanio}">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="${elementoJson}" name="${elementoJson}" value="${etiqueta}" readonly="readonly">
                                            <div class="input-group-append">
                                                ...
                                                <input type="hidden" id="hid${elementoJson}" name="hid${elementoJson}" value="0" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <a class="btn btn-info" id="btnBuscar" name="btnBuscar" onclick="getBusquedaModal(1)"><span class="fa fa-search"></span>Buscar</a>
                            </div>
                        </div>
                    </div>
